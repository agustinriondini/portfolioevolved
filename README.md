...
- [Fixes] Correccion de transparencias. Mejor visibilidad para el contenido.
- [Fixes] Correccion de visualizacion del icono del portfolio en la pestaña.
- [Update] Actualizacion del readme.md
- [Update] Actualizacion de version.
- [Update] Actualizacion del contenido.
- [Update] Actualizacion del contenido en proyectos.
...
- [Update] Actualizacion del contenido de skills.
- [Update] Cambio de animaciones y estilos en skills.
- [Update] Mejorada la UI.
- [Fixes] Correccion de errores de diseño en dispositivos moviles.
- [Update_UI] Footer nuevo. Rediseño completo.
- [Update_UI] Reemplazo de colores por variables.
================================================================================================================================================
