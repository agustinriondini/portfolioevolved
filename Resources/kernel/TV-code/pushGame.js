document.addEventListener("DOMContentLoaded", function() {
    ...
    var tvDisplay = document.getElementById("tvDisplay");
    tvDisplay.style.backgroundImage = '';
    tvDisplay.innerHTML = '<iframe src="https://github.com/agustinriondini" width="100%" height="100%" overflow-x="hidden" overflow-y="hidden" frameborder="0"></iframe>'
    }
    ...
    function playdemovid(){
        var tvDisplay = document.getElementById("tvDisplay");
        var ledNotif = document.getElementById("ledNotif");
        alert("Proyecto en fase de desarrollo, veras un video demo de algunas caracteristicas");
        tvDisplay.innerHTML = '<video id="videoPlayer" src="../Videos/video_demo_penguinSAS.mp4" autoplay></video>';   
        ledNotif.style.boxShadow = "0px 0px 10px green";
        tvDisplay.style.boxShadow = "0px  0px 10px var(--color-blanco)";
    }